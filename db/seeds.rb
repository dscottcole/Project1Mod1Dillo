...
laptop = Item.create(item_name: "Macbook Pro", user_id: 2,  location: "Houston", category: "Computers", condition: "New", price: 2000 , description: "2020 Macbook Pro. Hot buy!")
chair = Item.create(item_name: "Gaming Chair", user_id: 3, location: "Austin", category: "Furniture", condition: "Used_like_new", price: 250, description: "Awesome chair. Will raise KD and stream followers")
controller = Item.create(item_name: "Xbox 360 Controller", user_id: 3, location: "Austin", category: "Gaming", condition: "Used_not_great", price: 13.37, description: "Heavily used Xbox 360 Controller, good for mod body")
chucks = Item.create(item_name: "Converse High-Tops", user_id: 4, location: "Dallas", category: "Clothing", condition: "New", price: 39.99, description: "Size 11 Mens High-Top Chucks")
